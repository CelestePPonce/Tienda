...
const renderCarrito = ()=>{
	...
	if (carrito.length < 1){
		...
		carrito.forEach((productoCarrito)=>{
			...
			}else if(productoCarrito==='amarillo'){
...
btnAgregarCarrito.addEventListener('click',(e)=>{
	...
	notificacion.querySelectorAll('img').src = thumbSrc;
...
/*simulacion 
ventanaCarrito.querySelectorAll('#carrito__btn-comprar').addEventListener('click',(e)=>{
